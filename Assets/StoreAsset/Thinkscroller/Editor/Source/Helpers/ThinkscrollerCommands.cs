...
{
	// This variable controls the location of Thinkscroller menu commands.
	// Do not include the "Thinkscroller" folder in the name.
	// No trailing slashes allowed!
	public const string menuLocation = "Assets";
	...
	/// </remarks>
	[MenuItem (menuLocation + "/Thinkscroller/Create Parallax Scene")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Create Pixel-Perfect Scroll Layer")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Create Tiled Scroll Layer")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Create Stretched Scroll Layer")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Create Object Scroll Layer")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Create Parallax Manager")]
	...
	/// </summary>
	[MenuItem (menuLocation + "/Thinkscroller/Reference Manual...")]
